...
<template>
  <header class="site-header" :class="{ 'is-solid': solidHeader, 'menu-active': menuOpen }">
    <div class="header-inner">
      <RouterLink class="brand" to="/" aria-label="Felipe Amorim Advogados — início">
        <span class="brand-mark" aria-hidden="true"><span>FA</span></span>
        <span class="brand-lockup">
          <span class="brand-name">Felipe Amorim</span>
          <span class="brand-subtitle">Advogados</span>
        </span>
      </RouterLink>
      ...
      <a class="header-cta" :href="whatsappUrl()" target="_blank" rel="noopener">
        Fale com Felipe <ArrowUpRight :size="16" aria-hidden="true" />
      </a>
